...
- (IBAction)longMesage:(id)sender {
    Alert *alert = [[Alert alloc] initWithTitle:@"OPS" message:@"Você não receberá mais as atualizações dessa Editoria em sua aba de Interesses." delegate:nil cancelButtonTitle:@"VOLTAR" otherButtonTitles:@"CONTINUAR", nil];
    alert.contentAlignment = NSTextAlignmentLeft;
    [alert show];
}
